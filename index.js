...
function pauseVideo() {
  if (!videoPaused) {
    ...
    $("#favicon").attr("href", "data:image/png;base64,");
  }
  else {
    actionTimers.resume();
    videoPaused = false;
    document.title = "Streamly - " + decodeURIComponent(videos[videoIteration][0]);
    $("#favicon").attr("href", "data:image/png;base64,");
  }
