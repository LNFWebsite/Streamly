...
Going from one video to another is controlled by cycling through a Javascript array containing objects with the video's title, URL, and length (in seconds).
